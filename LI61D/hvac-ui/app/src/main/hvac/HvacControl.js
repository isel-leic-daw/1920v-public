 ...
 *                  by the user. The function receives the new power state.
 */
function HvacControl({powerState, onChange}) {
  ...
  function renderButton() {
    if (powerState) {
      ...
      return (<button className={"ui basic " + buttonColor} onClick={handleButtonClick}>
                <i className={"power off " + iconColor} /> {powerState} </button>)
    }
